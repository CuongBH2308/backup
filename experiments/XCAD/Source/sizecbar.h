...
/////////////////////////////////////////////////////////////////////////
// FW_SCBButton (button info) helper class
...
/////////////////////////////////////////////////////////////////////////
// FW_SCBDockBar dummy class for access to protected members

class FW_SCBDockBar : public CDockBar
{
    friend class FW_SizingControlBar;
};

/////////////////////////////////////////////////////////////////////////
// FW_SizingControlBar control bar styles
...
/////////////////////////////////////////////////////////////////////////
// FW_SizingControlBar control bar

#ifndef baseCSizingControlBar
#define baseCSizingControlBar CControlBar
#endif

class FW_SizingControlBar;
typedef CTypedPtrArray <CPtrArray, FW_SizingControlBar*> CSCBArray;

class FW_SizingControlBar : public baseCSizingControlBar
{
    DECLARE_DYNAMIC(FW_SizingControlBar);
...
public:
    ...
    //{{AFX_VIRTUAL(FW_SizingControlBar)
    public:
...
protected:
    ...
    FW_SCBButton m_biHide;

// Generated message map functions
protected:
    //{{AFX_MSG(FW_SizingControlBar)
