...
void CSocketDemoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CSocketDemoDlg::OnOK()
{
	...
	m_listener.Create(1600, SOCK_STREAM, FD_READ | FD_WRITE | FD_OOB | FD_ACCEPT | FD_CONNECT | FD_CLOSE, _T("127.0.0.1"));
	m_listener.Listen();
}
