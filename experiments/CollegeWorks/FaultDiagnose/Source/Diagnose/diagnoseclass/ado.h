...
struct AFX_EXT_CLASS CADOFieldInfo
{
	char m_strName[30]; 
	short m_nType;
	long m_lSize; 
...
public:
	...
	BOOL OpenByUdl(LPCTSTR lpstrConnection = _T(""), LPCTSTR lpstrUserID = _T(""), LPCTSTR lpstrPassword = _T(""));
...
public:
	...
	//CString GetFieldValue(LPCTSTR lpFieldName,  CString strDateFormat= _T(""));
...
class AFX_EXT_CLASS CADOParameter
{
public:
...
public:
	...
	BOOL SetActiveConnection(CADODatabase* pAdoDatabase);
	...
	_CommandPtr GetCommand()
		{return m_pCommand;};
	BOOL Excute(VARIANT *RecordsAffected = NULL ,VARIANT *Parameters = NULL,long options = 0);
