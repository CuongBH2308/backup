// MyCom1.cpp : Implementation of CMyCom1
#include "stdafx.h"
#include "Model.h"
#include "MyCom1.h"
...
IMPLEMENT_DYNAMIC(CMyCom1, CObject)
//IMPLEMENT_DYNAMIC(IMyCom1, CObject)

//new
STDMETHODIMP CMyCom1::Draw(unsigned long m_pDC, unsigned long m_pStartPoint, double m_Scale,
...
STDMETHODIMP CMyCom1::SetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::SetID(unsigned long ID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetIID(unsigned long pIID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pIID = (unsigned long)(&IID_IMyCom1);
	memcpy((void *)pIID, &IID_IMyCom1, sizeof(IID_IMyCom1));
	return S_OK;
}

STDMETHODIMP CMyCom1::GetCLSID(unsigned long pCLSID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pCLSID = (unsigned long)(&CLSID_MyCom1);
	memcpy((void *)pCLSID, &CLSID_MyCom1, sizeof(CLSID_MyCom1));
	return S_OK;
}

//new
STDMETHODIMP CMyCom1::GetTopLeft(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::SetActive(BOOL IsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetActive(unsigned long pIsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom1::GetRgn(unsigned long pRgn)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	// TODO: Add your implementation code here
	CRgn * rgn = (CRgn *)pRgn;
...
//new
STDMETHODIMP CMyCom1::InOtherRgn(unsigned long pRgn, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom1::InOtherRect(unsigned long pRect, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::OffsetRgn(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetTopCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetBottomCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetLeftCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetRightCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::SetStartPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::SetEndPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetID(unsigned long pID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::GetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom1::SetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
