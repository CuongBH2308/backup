// MyCom6.cpp : Implementation of CMyCom6
#include "stdafx.h"
#include "Model.h"
#include "MyCom6.h"
...
IMPLEMENT_DYNAMIC(CMyCom6, CObject)
//IMPLEMENT_DYNAMIC(IMyCom6, CObject)

//new
STDMETHODIMP CMyCom6::Draw(unsigned long m_pDC, unsigned long m_pStartPoint, double m_Scale,
...
STDMETHODIMP CMyCom6::DrawOffset(unsigned long m_pDC, unsigned long m_pOffset, double m_Scale, unsigned long m_pGraphInfo, BOOL scale_flag, BOOL m_active_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetID(unsigned long ID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom6::PtInRgn(unsigned long point, unsigned long return_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetIID(unsigned long pIID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pIID = (unsigned long)(&IID_IMyCom6);
	memcpy((void *)pIID, &IID_IMyCom6, sizeof(IID_IMyCom6));
	return S_OK;
}

STDMETHODIMP CMyCom6::GetCLSID(unsigned long pCLSID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pCLSID = (unsigned long)(&CLSID_MyCom6);
	memcpy((void *)pCLSID, &CLSID_MyCom6, sizeof(CLSID_MyCom6));
	return S_OK;
}

//new
STDMETHODIMP CMyCom6::GetTopLeft(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetActive(BOOL IsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetActive(unsigned long pIsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom6::GetRgn(unsigned long pRgn)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	// TODO: Add your implementation code here
	CRgn * rgn = (CRgn *)pRgn;
...
//new
STDMETHODIMP CMyCom6::InOtherRgn(unsigned long pRgn, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom6::InOtherRect(unsigned long pRect, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::OffsetRgn(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetTopCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetBottomCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	((CPoint *)pPoint)->x = (downPoints[2].x + downPoints[3].x) / 2;
	((CPoint *)pPoint)->y = downPoints[2].y;

	return S_OK;
}

STDMETHODIMP CMyCom6::GetLeftCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	((CPoint*)pPoint)->x = downPoints[4].x;
	((CPoint*)pPoint)->y = downPoints[4].y;

	return S_OK;
}


STDMETHODIMP CMyCom6::GetRightCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetStartPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetEndPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetID(unsigned long pID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::GetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom6::SetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
