...
IMPLEMENT_DYNAMIC(CMyCom2, CObject)
//IMPLEMENT_DYNAMIC(IMyCom2, CObject)

//new
STDMETHODIMP CMyCom2::Draw(unsigned long m_pDC, unsigned long m_pStartPoint, double m_Scale,
...
STDMETHODIMP CMyCom2::DrawOffset(unsigned long m_pDC, unsigned long m_pOffset, double m_Scale, unsigned long m_pGraphInfo, BOOL scale_flag, BOOL m_active_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetID(unsigned long ID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom2::PtInRgn(unsigned long point, unsigned long return_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetIID(unsigned long pIID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pIID = (unsigned long)(&IID_IMyCom2);
	memcpy((void *)pIID, &IID_IMyCom2, sizeof(IID_IMyCom2));
	return S_OK;
}

STDMETHODIMP CMyCom2::GetCLSID(unsigned long pCLSID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pCLSID = (unsigned long)(&CLSID_MyCom2);
	memcpy((void *)pCLSID, &CLSID_MyCom2, sizeof(CLSID_MyCom2));
	return S_OK;
}

//new
STDMETHODIMP CMyCom2::GetTopLeft(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetActive(BOOL IsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetActive(unsigned long pIsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom2::GetRgn(unsigned long pRgn)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	// TODO: Add your implementation code here
	CRgn * rgn = (CRgn *)pRgn;
...
//new
STDMETHODIMP CMyCom2::InOtherRgn(unsigned long pRgn, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom2::InOtherRect(unsigned long pRect, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::OffsetRgn(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetTopCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetBottomCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetLeftCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetRightCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetStartPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetEndPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetID(unsigned long pID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::GetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom2::SetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
