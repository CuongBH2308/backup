// MyCom3.cpp : Implementation of CMyCom3
#include "stdafx.h"
#include "Model.h"
#include "MyCom3.h"
...
IMPLEMENT_DYNAMIC(CMyCom3, CObject)
//IMPLEMENT_DYNAMIC(IMyCom3, CObject)

//new
STDMETHODIMP CMyCom3::Draw(unsigned long m_pDC, unsigned long m_pStartPoint, double m_Scale,
...
STDMETHODIMP CMyCom3::DrawOffset(unsigned long m_pDC, unsigned long m_pOffset, double m_Scale, unsigned long m_pGraphInfo, BOOL scale_flag, BOOL m_active_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::SetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::SetID(unsigned long ID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom3::PtInRgn(unsigned long point, unsigned long return_flag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetIID(unsigned long pIID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pIID = (unsigned long)(&IID_IMyCom3);
	memcpy((void *)pIID, &IID_IMyCom3, sizeof(IID_IMyCom3));
	return S_OK;
}

STDMETHODIMP CMyCom3::GetCLSID(unsigned long pCLSID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	//pCLSID = (unsigned long)(&CLSID_MyCom3);
	memcpy((void *)pCLSID, &CLSID_MyCom3, sizeof(CLSID_MyCom3));
	return S_OK;
}

//new
STDMETHODIMP CMyCom3::GetTopLeft(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::SetActive(BOOL IsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetActive(unsigned long pIsActive)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom3::GetRgn(unsigned long pRgn)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	// TODO: Add your implementation code here
	CRgn * rgn = (CRgn *)pRgn;
...
//new
STDMETHODIMP CMyCom3::InOtherRgn(unsigned long pRgn, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//new
STDMETHODIMP CMyCom3::InOtherRect(unsigned long pRect, float scale, unsigned long pFlag)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::OffsetRgn(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetTopCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetBottomCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	((CPoint *)pPoint)->x = (downPoints[1].x+downPoints[2].x)/2;
	((CPoint *)pPoint)->y = downPoints[1].y;

	return S_OK;
}

STDMETHODIMP CMyCom3::GetLeftCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	((CPoint*)pPoint)->x = (downPoints[0].x+downPoints[2].x)/2;
	((CPoint*)pPoint)->y = (downPoints[0].y+downPoints[2].y)/2;

	return S_OK;
}


STDMETHODIMP CMyCom3::GetRightCenter(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	// TODO: Add your implementation code here
	((CPoint*)pPoint)->x = (downPoints[0].x+downPoints[1].x)/2;
	((CPoint*)pPoint)->y = (downPoints[0].y+downPoints[1].y)/2;

	return S_OK;
}


STDMETHODIMP CMyCom3::SetStartPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::SetEndPoint(unsigned long pPoint)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetName(unsigned long pName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetID(unsigned long pID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::GetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CMyCom3::SetGraphInfo(unsigned long pGraphInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
