// MyCom11.h : Declaration of the CMyCom11
...
/////////////////////////////////////////////////////////////////////////////
// CMyCom11
class ATL_NO_VTABLE CMyCom11 : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CMyCom11, &CLSID_MyCom11>,
	public IDispatchImpl<IMyCom11, &IID_IMyCom11, &LIBID_MODELLib>,
	public CBaseCom
{
		DECLARE_DYNAMIC(CMyCom11)
public:
	CMyCom11()//:m_GraphInfo()
	{
		isActive = FALSE;
		m_name = _T("COM_11");
		m_ID = 0;
...
DECLARE_REGISTRY_RESOURCEID(IDR_MYCOM11)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CMyCom11)
	COM_INTERFACE_ENTRY(IMyCom11)
